...
async def fetch_top_animal(query):
    ...
    return await fetch_max_search_doc(query, prompt_animals, engine="gpt-3.5-turbo-instruct")
...
async def fetch_three_top_animals(query, n):
    ...
    return await fetch_max_search_doc(query, prompt_animals, engine="gpt-3.5-turbo-instruct", n=n)
