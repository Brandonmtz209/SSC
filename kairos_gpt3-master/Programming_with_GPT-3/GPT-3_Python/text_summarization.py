...
async def summarization_example():
    ...
    completion_summarize = await cleaned_completion(prompt_summarize, max_tokens=100, engine="gpt-3.5-turbo-instruct", temperature=0.5, top_p=1, frequency_penalty=0.2, stop=["\n\n"])
